    ...
    <div className="bg-gray-100 p-8">
      ...
      >
        ...
        <div className="container mx-auto h-full flex flex-col justify-center items-center text-center text-white relative z-10">
          ...
          <i className="text-lg md:text-xl mb-8">
      ...
      <div className="container mx-auto mt-8 text-center py-16 bg-gray-200 rounded-lg shadow-md">
      ...
      <div className="container mx-auto text-center py-16">
        ...
        <p className="text-lg md:text-xl text-gray-600 mb-8">
          ...
          clients. With expertise in: <br />
          <b className="text-grey-800 ">
            Web Development, E-commerce, ERP, Digital Marketing, and UI/UX
            design.
          </b>
          <br />
      ...
      <div className="container mx-auto text-center py-16">
        ...
        <Link
          to="/contact"
          className="bg-gray-800 px-6 py-3 rounded-md text-lg text-white md:text-xl hover:bg-black transition duration-300"
        >
          Contact Us
        </Link>
      </div>
